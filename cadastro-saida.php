...
<body>
                ...
                <ul class="nav">
                    ...
                    <?php
                        if($_SESSION['tipoUser'] == 'superiores'){
                            ...
                            <li class='nav-item active btn-add-s-peps' style='cursor: pointer;'>
                                <a class='nav-link'>
            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        <a class="navbar-brand" href="javascript:;">Cadastrar Saída PEPS</a>
                                    ...
                                    <form id="form-saida">
                                        <div class="row">
                                            <div class="col-md-4 col-4 col-lg-4 col-sm-4">
                                                <input class="form-control nome" readonly value="<?php echo($_SESSION['nome']); ?>" placeholder="Nome do Responsável" type="text" name="nome">
                                            </div>
                                            <div class="col-md-3 col-3 col-lg-3 col-sm-3">
                                                <input class="form-control text-center data_saida" value='value="<?php echo(date("d/m/Y")); ?>"' readonly placeholder="Data da Saída (apneas numeros)" id="data_saida" type="text" name="data_saida">
                                            </div>
                                        ...
                                        <button class="btn btn-success btn-block btn-add-saida" type="submit" style="height: auto !important;">
                                            Cadastrar
                                        </button>
                                    </form>
                                </div>
    ...
    <script src="src/saidas/controle/add-saida.js"></script>
